...
private VeiculoService veiculoService;
    ...
    @PostMapping
    public ResponseEntity<VeiculoResponseDTO> criarVeiculo(@RequestBody VeiculoRequestDTO veiculoDTO){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<VeiculoResponseDTO> atualizarVeiculo(@PathVariable Long id, @RequestBody VeiculoRequestDTO veiculoDTO ){
